const FERTILIZER_PROFILES = {
  ...
  'Athena Pro': {
    ...
    calmagNote: 'Athena CaMg ist Teil des Pro-Line Feed Charts. In Kokos mitführen laut Athena-Schema (meist 1-3 ml/L). Laut Athena Feed Chart wird CaMg nur bis ca. Woche 7 der Blüte dosiert — danach nicht mehr relevant. KEIN fremdes CalMag verwenden.',
  ...
  'Athena Blended': {
    ...
    calmagProduct: 'Athena CaMg',
    calmagNote: 'Athena Blended Feed Chart enthält CaMg-Dosierung. In Kokos mitführen laut Feed Chart. CaMg wird nur bis ca. Woche 7 der Blüte dosiert — danach nicht mehr relevant. KEIN fremdes CalMag verwenden – Athena-System ist aufeinander abgestimmt.',
  ...
  'Jacks Nutrients': {
    ...
    ecRanges: { seedling: '0.4–0.6', earlyVeg: '0.8–1.4', lateVeg: '1.4–1.8', earlyFlower: '1.6–2.2', midFlower: '1.8–2.4', lateFlower: '2.0–2.6', flush: '0.4–0.8' },
  ...
  'Veg+Bloom': {
    ...
    ecRanges: { seedling: '0.4–0.8', earlyVeg: '1.0–1.4', lateVeg: '1.4–2.0', earlyFlower: '1.8–2.4', midFlower: '2.0–2.6', lateFlower: '2.2–2.8', flush: '0.4–0.8' },
  ...
  'Rx Green Technologies': {
    ...
    ecRanges: { seedling: '0.4–0.6', earlyVeg: '0.8–1.2', lateVeg: '1.2–1.6', earlyFlower: '1.4–1.8', midFlower: '1.6–2.0', lateFlower: '1.8–2.2', flush: '0.4–0.6' },
  ...
  'Emerald Harvest': {
    ...
    ecRanges: { seedling: '0.4–0.6', earlyVeg: '0.8–1.4', lateVeg: '1.2–1.8', earlyFlower: '1.4–2.0', midFlower: '1.6–2.2', lateFlower: '1.8–2.4', flush: '0.4–0.8' },
  ...
  'Canna Coco A+B': {
    ...
    ecRanges: { seedling: '0.4–0.8', earlyVeg: '0.8–1.2', lateVeg: '1.2–1.6', earlyFlower: '1.4–1.8', midFlower: '1.6–2.0', lateFlower: '1.8–2.2', flush: '0.8–1.0' },
  ...
  'Canna Terra': {
    ...
    ecRanges: { seedling: '0.4–0.6', earlyVeg: '0.6–1.0', lateVeg: '1.0–1.4', earlyFlower: '1.2–1.6', midFlower: '1.4–1.8', lateFlower: '1.6–2.0', flush: '0.6–0.8' },
  ...
  'Canna Aqua': {
    ...
    ecRanges: { seedling: '0.4–0.6', earlyVeg: '0.8–1.2', lateVeg: '1.2–1.6', earlyFlower: '1.4–1.8', midFlower: '1.6–2.0', lateFlower: '1.8–2.2', flush: '0.6–0.8' },
  ...
  'Hesi': {
    ...
    ecRanges: { seedling: '0.4–0.6', earlyVeg: '0.8–1.2', lateVeg: '1.0–1.4', earlyFlower: '1.2–1.6', midFlower: '1.4–1.8', lateFlower: '1.6–2.0', flush: '0.4–0.6' },
  ...
  'Plagron': {
    ...
    ecRanges: { seedling: '0.4–0.6', earlyVeg: '0.8–1.2', lateVeg: '1.0–1.6', earlyFlower: '1.4–1.8', midFlower: '1.6–2.0', lateFlower: '1.8–2.2', flush: '0.6–0.8' },
  ...
  'General Hydroponics Flora': {
    ...
    ecRanges: { seedling: '0.4–0.6', earlyVeg: '0.8–1.2', lateVeg: '1.2–1.6', earlyFlower: '1.4–1.8', midFlower: '1.6–2.0', lateFlower: '1.8–2.2', flush: '0.4–0.8' },
  ...
  'Advanced Nutrients pH Perfect': {
    ...
    ecRanges: { seedling: '0.4–0.8', earlyVeg: '0.8–1.2', lateVeg: '1.2–1.8', earlyFlower: '1.4–2.0', midFlower: '1.6–2.2', lateFlower: '1.8–2.4', flush: '0.6–0.8' },
  ...
  'Metrop': {
    ...
    ecRanges: { seedling: '0.4–0.8', earlyVeg: '1.0–1.6', lateVeg: '1.6–2.2', earlyFlower: '2.0–2.6', midFlower: '2.2–2.8', lateFlower: '2.4–3.0', flush: '0.4–0.8' },
  ...
  'Growth Technology': {
    ...
    ecRanges: { seedling: '0.4–0.6', earlyVeg: '0.8–1.2', lateVeg: '1.0–1.6', earlyFlower: '1.4–1.8', midFlower: '1.6–2.0', lateFlower: '1.8–2.2', flush: '0.4–0.6' },
  ...
  'Remo Nutrients': {
    ...
    ecRanges: { seedling: '0.4–0.6', earlyVeg: '0.8–1.2', lateVeg: '1.2–1.6', earlyFlower: '1.4–2.0', midFlower: '1.6–2.2', lateFlower: '1.8–2.4', flush: '0.4–0.8' },
  ...
  'Guanokalong': {
    ...
    ecRanges: { seedling: '0.2–0.4', earlyVeg: '0.4–0.8', lateVeg: '0.6–1.0', earlyFlower: '0.8–1.2', midFlower: '1.0–1.4', lateFlower: '1.2–1.6', flush: '0.2–0.4' },
  ...
  'Green Buzz Liquids': {
    ...
    ecRanges: { seedling: '0.4–0.6', earlyVeg: '0.6–1.0', lateVeg: '0.8–1.4', earlyFlower: '1.0–1.6', midFlower: '1.2–1.6', lateFlower: '1.4–1.8', flush: '0.4–0.6' },
...
module.exports.getFertilizerNames = function getFertilizerNames() {
...
module.exports.getFertilizerContext = function getFertilizerContext(fertilizerName, plantAge, growPhase) {
  ...
  context += '\n- SPÄTBLÜTE/FLUSH-REGEL (Woche 8+): CalMag ist in dieser Phase KEIN THEMA. Erwähne CalMag ÜBERHAUPT NICHT — weder als Empfehlung, noch als Warnung, noch als Präventionstipp. Das Wort CalMag/CaMg darf in der gesamten Antwort NICHT vorkommen wenn die Pflanze in Woche 8+ ist. Fokussiere dich ausschließlich auf Flush/Ernte-relevante Themen.';
