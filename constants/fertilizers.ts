export interface FertilizerProfile {
  ...
  ecRanges: {
    seedling: string; // Woche 0–2 Veg
    earlyVeg: string; // Woche 3–4 Veg
    lateVeg: string; // Woche 5–8 Veg
    earlyFlower: string; // Blüte Woche 1–2 (Stretch)
    midFlower: string; // Blüte Woche 3–4
    lateFlower: string; // Blüte Woche 5–8 (Peak Bloom / Reife)
    flush: string; // Blüte Woche 9–12 (Ernte / Seneszenz)
  };
...
export const FERTILIZER_PROFILES: Record<string, FertilizerProfile> = {
  ...
  'Athena Pro': {
    ...
    calmagNote:
      'Athena CaMg ist Teil des Pro-Line Feed Charts. In Kokos mitführen laut Athena-Schema (meist 1-3 ml/L). WICHTIG: Laut Athena Feed Chart wird CaMg nur bis ca. Woche 7 der Blüte dosiert. Ab Woche 8+ (Fade/Flush) wird CaMg NICHT mehr gegeben! In der Spätblüte (Woche 9-12) ist CaMg kontraproduktiv. KEIN fremdes CalMag verwenden.',
    notes:
      'Hochkonzentriertes Mineralsalz-System (Core + Bloom). EC bewusst höher. Nur Athena-eigene Produkte empfehlen!',
  },
  'Athena Blended': {
    name: 'Athena Blended',
    brand: 'Athena',
  ...
  'Jacks Nutrients': {
    name: 'Jacks Nutrients (JR Peters)',
    brand: 'Jacks',
    type: 'mineral',
    ecRanges: {
      seedling: '0.4–0.6',
    ...
    calmagNote:
      'Jacks 321 besteht aus Part A (5-12-26) + Part B (Calcium Nitrate) + Epsom Salt. CalMag ist über Part B + Epsom bereits im System. Kein zusätzliches CalMag nötig wenn 321 korrekt gemischt.',
  ...
  'Veg+Bloom': {
    ...
    calmagNote:
      'Veg+Bloom enthält bereits Ca und Mg. In hartem Wasser kein Extra-CalMag nötig. Bei weichem Wasser/RO ggf. +CaMg von Hydroponic Research.',
    notes: 'Ein-Komponenten-System. Starke Konzentration. Eigene Zusätze (Shine, Stackswell) empfehlen.',
  },
  'Rx Green Technologies': {
    name: 'Rx Green Technologies',
    brand: 'Rx Green',
    type: 'mineral',
    ecRanges: {
      seedling: '0.4–0.6',
    ...
    calmagNote: 'Kein herstellereigenes CalMag. Bei Bedarf generisches CalMag verwenden.',
  ...
  'Emerald Harvest': {
    ...
    calmagProduct: 'Emerald Harvest Cal-Mag',
    calmagNote: 'Eigenes Cal-Mag Produkt verfügbar. In Kokos empfohlen.',
  ...
  'Cutting Edge Solutions': {
    ...
    calmagProduct: 'CES CaMg+',
    calmagNote: 'Eigenes CalMag-Produkt. Bei Kokos/RO-Wasser empfohlen.',
  ...
  'Dyna-Gro': {
    ...
    calmagProduct: 'Dyna-Gro Mag-Pro',
    calmagNote: 'Mag-Pro für extra Mg. Foliage-Pro enthält bereits Ca/Mg. In Kokos Mag-Pro hinzufügen.',
  ...
  'Canna Coco A+B': {
    ...
    calmagNote:
      'Canna CalMag Agent für Kokos/weiches Wasser. CALMAG Agent ist speziell auf Canna abgestimmt. Kein fremdes CalMag verwenden.',
  ...
  'Canna Terra': {
    ...
    calmagProduct: 'Canna CalMag Agent',
    calmagNote: 'In Erde selten nötig. Falls doch: Canna CalMag Agent verwenden.',
  ...
  'Canna Aqua': {
    ...
    calmagProduct: 'Canna CalMag Agent',
    calmagNote: 'In Hydro bei weichem Wasser/RO: Canna CalMag Agent.',
  ...
  Hesi: {
    ...
    calmagProduct: 'Kein eigenes CalMag',
    calmagNote: 'Hesi hat kein eigenes CalMag. Bei Bedarf generisches CalMag verwenden.',
  ...
  Plagron: {
    ...
    calmagNote: 'Plagron CalMag Pro für Kokos/weiches Wasser. Im Plagron-System bleiben.',
    notes: 'Niederländischer Premium-Dünger. Verschiedene Linien.',
  },
  'General Hydroponics Flora': {
    name: 'General Hydroponics / Terra Aquatica Flora',
    ...
    calmagProduct: 'GHE CALiMAGic / Terra Aquatica CalMag',
    calmagNote: 'CALiMAGic (GHE) bzw. CalMag (Terra Aquatica). In Kokos/Hydro/RO-Wasser empfohlen.',
  ...
  'Advanced Nutrients pH Perfect': {
    ...
    calmagProduct: 'Advanced Nutrients Sensi Cal-Mag Xtra',
    calmagNote: 'Sensi Cal-Mag Xtra für Kokos. pH Perfect System puffert pH automatisch.',
    notes: 'pH-buffered System. Nur AN-Produkte empfehlen.',
  },
  "Atami (ATA / B'Cuzz)": {
    name: "Atami (ATA / B'Cuzz)",
    brand: 'Atami',
    type: 'mineral',
    ecRanges: {
      seedling: '0.4–0.6',
    ...
    calmagNote: 'Atami hat ein eigenes CalMag. Bei Kokos empfohlen.',
  ...
  'House & Garden': {
    ...
    calmagNote: 'Eigenes CalMag-Produkt. In Kokos (Coco-Linie) oft nötig.',
  ...
  BioNova: {
    ...
    calmagNote: 'Eigenes CalMag verfügbar. Bei Kokos empfohlen.',
  ...
  Metrop: {
    ...
    calmagProduct: 'Metrop CalGreen',
    calmagNote: 'CalGreen für Ca/Mg-Supplementierung. Bei Kokos empfohlen. Dosierung sehr gering da hochkonzentriert!',
  ...
  'Growth Technology': {
    ...
    calmagProduct: 'Growth Technology CalMag',
    calmagNote: 'Eigenes CalMag-Produkt verfügbar.',
  ...
  Grotek: {
    ...
    calmagProduct: 'Grotek Cal-Max',
    calmagNote: 'Cal-Max für Ca/Mg-Supplementierung. Bei Kokos empfohlen.',
  ...
  'Mills Nutrients': {
    ...
    calmagProduct: 'Mills CalMag',
    calmagNote: 'Eigenes CalMag-Produkt. In Kokos empfohlen. Im Mills-System bleiben.',
  ...
  'Green House Feeding': {
    ...
    calmagProduct: 'Green House Calcium',
    calmagNote: 'Calcium-Pulver als Ca-Supplement. Für Mg: Bittersalz (Epsom). Bei Kokos empfohlen.',
  ...
  'Remo Nutrients': {
    ...
    calmagProduct: 'Remo MagnifiCal',
    calmagNote: 'MagnifiCal ist Remos CalMag-Produkt. Bei Kokos empfohlen. Im Remo-System bleiben.',
  ...
  BioBizz: {
    ...
    calmagNote:
      'BioBizz CalMag ist organisch und auf das BioBizz-System abgestimmt. Bei Kokos empfohlen. Kein mineralisches CalMag verwenden im Bio-System.',
    notes:
      'Organisch. EC-Messung weniger aussagekräftig (organische Bestandteile verfälschen). pH stellt sich in Erde meist selbst ein.',
  },
  BioCanna: {
    name: 'BioCanna',
    brand: 'Canna',
    ...
    calmagProduct: 'Canna CalMag Agent',
    calmagNote:
      'Canna CalMag Agent ist auch für BioCanna geeignet. Bei weichem Wasser empfohlen. Im Canna-System bleiben.',
    notes: 'Organische Linie von Canna. Nur für Erde geeignet. Niedrigere EC als Mineral-Varianten.',
  },
  'Plagron Alga / Bio': {
    name: 'Plagron Alga / Bio',
    brand: 'Plagron',
    type: 'organic',
    ecRanges: {
      seedling: '0.4–0.6',
  ...
  Guanokalong: {
    ...
    calmagProduct: 'Kein eigenes CalMag',
    calmagNote:
      'Guanokalong hat kein eigenes CalMag. In Bio-Grows: Dolomit-Kalk oder organisches CalMag eines kompatiblen Herstellers.',
  ...
  BioTabs: {
    ...
    calmagNote:
      'BioTabs Startrex enthält Calcium. Zusätzliches CalMag selten nötig bei Water-Only. Bei Bedarf: Dolomit-Kalk.',
    notes:
      'Tabletten-/Granulat-System für "Water Only"-Grows. EC-Messung kaum aussagekräftig da organisch + Slow-Release.',
  },
  'Green Buzz Liquids': {
    name: 'Green Buzz Liquids',
    brand: 'Green Buzz',
    type: 'organic',
    ecRanges: {
      seedling: '0.4–0.6',
  ...
  Aptus: {
    ...
    calmagNote:
      'Aptus CaMg-BOOST ist hochkonzentriert (geringe Dosierung!). Bei Kokos empfohlen. Im Aptus-System bleiben.',
  ...
  'Terra Aquatica Organic': {
    ...
    calmagNote:
      'Terra Aquatica CalMag (ehemals GHE CALiMAGic) auch für die organische Linie nutzbar. Bei Kokos/RO empfohlen.',
  ...
  'Advanced Nutrients OG Organics': {
    name: 'Advanced Nutrients OG Organics',
    brand: 'Advanced Nutrients',
    type: 'organic',
    ecRanges: {
      seedling: '0.4–0.6',
  ...
  'Eigener Bio-Dünger / DIY': {
    ...
    calmagNote: 'DIY CalMag: Eierschalenmehl für Ca, Bittersalz für Mg. Dolomit-Kalk liefert beides.',
    notes:
      'Selbstgemischter organischer Dünger. Komposttee, Wurmhumus, Brennnesseljauche, etc. EC-Messung unbrauchbar.',
  },
};
...
export function isOrganicFertilizer(fertilizerName: string | null): boolean {
...
export function getFertilizerContext(
  ...
  if (plantAge && growPhase) {
    ...
    if (plantAge.includes('0–2') && !isFlower) {
      ecRange = profile.ecRanges.seedling;
      phase = 'Sämling';
    } else if (plantAge.includes('3–4') && !isFlower) {
      ecRange = profile.ecRanges.earlyVeg;
      phase = 'frühe Veg';
    } else if (plantAge.includes('5–8') && !isFlower) {
      ecRange = profile.ecRanges.lateVeg;
      phase = 'späte Veg';
    } else if (plantAge.includes('0–2') && isFlower) {
      ecRange = profile.ecRanges.earlyFlower;
      phase = 'frühe Blüte (Woche 1–2)';
    } else if (plantAge.includes('3–4') && isFlower) {
      ecRange = profile.ecRanges.midFlower;
      phase = 'mittlere Blüte (Woche 3–4)';
    } else if (plantAge.includes('5–8') && isFlower) {
      ecRange = profile.ecRanges.lateFlower;
      phase = 'späte Blüte (Woche 5–8)';
    } else if (plantAge.includes('9–12') && isFlower) {
      ecRange = profile.ecRanges.flush;
      phase = 'Ernte/Seneszenz (Woche 9–12)';
    } else if (plantAge.includes('9–12') && !isFlower) {
      ecRange = profile.ecRanges.lateVeg;
      phase = 'späte Veg';
    } else if (growPhase === 'Mutterpflanze') {
      ecRange = profile.ecRanges.lateVeg;
      phase = 'Mutterpflanze (Veg-Werte)';
    }
  } else if (plantAge) {
    if (plantAge.includes('0–2')) {
      ecRange = profile.ecRanges.seedling;
      phase = 'Sämling';
    } else if (plantAge.includes('3–4')) {
      ecRange = profile.ecRanges.earlyVeg;
      phase = 'frühe Veg';
    } else if (plantAge.includes('5–8')) {
      ecRange = profile.ecRanges.lateVeg;
      phase = 'späte Veg';
    } else if (plantAge.includes('9–12')) {
      ecRange = profile.ecRanges.lateFlower;
      phase = 'Blüte (Phase unbekannt)';
    }
  }

  const typeLabel =
    profile.type === 'organic' ? 'organisch' : profile.type === 'hybrid' ? 'hybrid (bio+mineral)' : 'mineralisch';
  ...
  if (ecRange && phase) {
    ...
    context +=
      '\n- WICHTIG: Bewerte den EC-Wert im Kontext DIESES Düngers! Ein EC von 2.3 bei ' +
      profile.name +
  ...
  context +=
    '\n- ABSOLUTE REGEL: Empfehle NUR Produkte von ' +
    profile.brand +
    '! NIEMALS CalMag oder Zusätze von anderen Herstellern empfehlen!';
